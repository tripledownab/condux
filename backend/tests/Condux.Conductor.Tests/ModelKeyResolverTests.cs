...
public class ModelKeyResolverTests
{
    ...
    public async Task Uses_the_orgs_byo_key_and_model_when_configured()
    {
        ...
        var resolver = new ModelKeyResolver("platform-default-key", new FakeReader(config), box);
    ...
    {
        var resolver = new ModelKeyResolver(
    ...
    {
        var resolver = new ModelKeyResolver("platform-default-key", configs: null, box: null);
