...
public class PlanCatalogExportTests
{
    ...
    {
        // Walk up to the repo root: the test runs from its bin directory, and the package it feeds sits
        // in the workspace rather than beside the test.
        ...
        Assert.NotNull(dir);
        return Path.Combine(dir!.FullName, "packages", "plans", "plans.json");
    }
