...
public final class ConduxClientTest {
    ...
    private record Scripted(Integer status, Map<String, String> headers, String error) {
    ...
    /** Replays a scripted sequence (the last repeats); records requests, bodies, and backoff delays. */
